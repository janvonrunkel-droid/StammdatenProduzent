...
export function ArticleFilterSidebar({
  ...
  return (
    <aside className="w-64 shrink-0 hidden lg:block">
      <div className="sticky top-4 rounded-lg border bg-card p-4 space-y-6">
        ...
        <Collapsible open={tagsOpen} onOpenChange={setTagsOpen}>
          ...
          <CollapsibleContent className="pt-3">
            <ScrollArea className={showAllTags && sortedTags.length > 8 ? 'h-48' : undefined}>
            ...
            {hasMoreTags && (
              ...
              >
                {showAllTags
                  ? 'Weniger anzeigen'
                  : `+${sortedTags.length - 5} mehr anzeigen`}
              </Button>
            )}
          </CollapsibleContent>
        </Collapsible>
